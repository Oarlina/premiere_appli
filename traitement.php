...
if (isset($_GET['action'])) // si le get action est pas vide
{
    switch ($_GET['action']) { // alors je regarde quel conditions je dois faire
        ...
        case "delete":
            ...
            $_SESSION['message']= "<<p class='alerte'>$nom a ete supprimé</p>"; // on affiche que le produit a ete supprimer et on dit lequel
        ...
        case "clear":
            ...
            $_SESSION['message']= "<p class='alerte'>Tout a ete supprimé</p>"; // on affiche que le tableau a ete vider
            header("Location:recap.php"); // c'est une redirection a la page index
            break;
